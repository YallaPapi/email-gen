...
# GOOD - Real keys (format examples):
# ANTHROPIC_API_KEY=sk-ant-api03-[64_CHARACTER_KEY_FROM_ANTHROPIC_CONSOLE]
# PERPLEXITY_API_KEY=pplx-[40_CHARACTER_KEY_FROM_PERPLEXITY_API]

# BAD - Placeholder or example keys:
# ANTHROPIC_API_KEY=your_key_here
# PERPLEXITY_API_KEY=placeholder_key
```
